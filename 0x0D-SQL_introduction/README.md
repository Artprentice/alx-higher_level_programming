# MySQL - Introduction
Project done during **Full Stack Software Engineering studies** at **Alx SE**. It aims to learn about databases, relational databases, subqueries, tables, **MySQL** statements and functions.
